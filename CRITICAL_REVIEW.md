...
`1.1.1000050` 이후 [추가 검토와 수정](POST_RELEASE_REVIEW.md)에서 다른 입력·응답 경계의 6건도 수정했다. 현재 작업 트리의 전체 검사는 940개 통과이며, 두 실제 웹뷰의 FK·JSON 편집 E2E도 통과했다. 아래 내용은 앞선 릴리스 수정의 기록이다.
