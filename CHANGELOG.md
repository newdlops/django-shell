...
- VS Code E2E activates its own macOS process and delivers webview pointer input through Chromium, covering foreign-key focus departure and return in both Model Data and ORM Query.
