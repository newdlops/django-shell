...
export function overlayRendererSource(modelUri: string): string {
  return `
    ...
    function __dsoEnsureStyle() {
      ...
      style.textContent = ".django-shell-overlay{position:absolute;left:0;top:0;width:1px;height:1px;z-index:10;box-sizing:border-box;overflow:hidden;background:var(--vscode-editor-background);color:var(--vscode-foreground);border:0;font-family:var(--vscode-font-family)}.django-shell-overlay-head{display:none}.django-shell-overlay-title{font-size:12px;color:var(--vscode-descriptionForeground)}.django-shell-overlay-spacer{flex:1}.django-shell-overlay button{border:0;border-radius:3px;padding:2px 8px;color:var(--vscode-button-foreground);background:var(--vscode-button-background)}.django-shell-overlay-editor{height:100%;min-height:80px}.django-shell-overlay .dso-exec-range{background:var(--vscode-editor-selectionHighlightBackground,rgba(90,150,255,.18));box-shadow:inset 3px 0 0 var(--vscode-focusBorder,rgba(90,150,255,.9))}.django-shell-overlay .dso-exec-range-start{box-shadow:inset 0 1px 0 var(--vscode-focusBorder,rgba(90,150,255,.9))}.django-shell-overlay .dso-exec-range-end{box-shadow:inset 0 -1px 0 var(--vscode-focusBorder,rgba(90,150,255,.9))}.django-shell-overlay .dso-exec-range-rail{background:var(--vscode-focusBorder,rgba(90,150,255,.9));width:3px!important;margin-left:3px}.django-shell-overlay .dso-debug-line{background:color-mix(in srgb,var(--vscode-editor-stackFrameHighlightBackground,#ffff0033) 70%,transparent);box-shadow:inset 3px 0 0 var(--vscode-editorStackFrameHighlight.border,var(--vscode-charts-yellow,#cca700))}.django-shell-overlay .dso-debug-rail{background:var(--vscode-charts-yellow,#cca700);width:3px!important;margin-left:3px}.django-shell-overlay .dso-breakpoint-line{background:color-mix(in srgb,var(--vscode-debugIcon-breakpointForeground,#e51400) 10%,transparent)}.django-shell-overlay .dso-breakpoint-glyph::before{content:'';display:block;width:9px;height:9px;margin:4px auto 0;border-radius:50%;background:var(--vscode-debugIcon-breakpointForeground,#e51400);box-shadow:0 0 0 1px var(--vscode-editor-background)}.django-shell-overlay .dso-breakpoint-rail{background:var(--vscode-debugIcon-breakpointForeground,#e51400);width:3px!important;margin-left:3px}.django-shell-overlay-output,.django-shell-overlay-output.error{display:none}.monaco-workbench .tab[aria-label='analysis.py'],.monaco-workbench .tab[aria-label='console-cell.py'],.monaco-workbench .tab[aria-label*='.django-shell'][aria-label*='analysis.py'],.monaco-workbench .tab[title*='/.django-shell/analysis.py'],.monaco-workbench .tab[aria-label*='.django-shell'][aria-label*='console-cell.py'],.monaco-workbench .tab[title*='/.django-shell/console-cell.py']{display:none!important}";
