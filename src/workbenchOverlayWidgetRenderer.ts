...
export function overlayWidgetRendererSource(): string {
  return `
    ...
    function __dsoEnsureWidgetStyle() {
      ...
      style.textContent = ".django-shell-overlay-widget-root{position:fixed;left:0;top:0;width:0;height:0;min-width:0!important;min-height:0!important;overflow:visible!important;z-index:2147483647!important;pointer-events:none;background:transparent!important}.django-shell-overlay-widget-layer{position:absolute;left:0;top:0;width:100vw;height:100vh;min-width:100vw!important;min-height:100vh!important;overflow:visible!important;z-index:2147483647!important;pointer-events:none;background:transparent!important}.django-shell-overlay-widget-layer .overflowingContentWidgets{overflow:visible!important;z-index:2147483647!important}.django-shell-overlay-widget-layer .monaco-resizable-hover,.django-shell-overlay-widget-layer .monaco-hover,.django-shell-overlay-widget-layer .monaco-editor-hover,.django-shell-overlay-widget-layer .suggest-widget,.django-shell-overlay-widget-layer .parameter-hints-widget,.django-shell-overlay-widget-layer .context-view{pointer-events:auto!important}.django-shell-overlay-widget-layer .monaco-resizable-hover .monaco-sash.disabled,.django-shell-overlay-widget-layer .monaco-hover .monaco-sash.disabled,.django-shell-overlay-widget-layer .monaco-editor-hover .monaco-sash.disabled{pointer-events:none!important}.django-shell-overlay-widget-layer .monaco-hover,.django-shell-overlay-widget-layer .monaco-editor-hover{background:var(--vscode-editorHoverWidget-background,var(--vscode-editorWidget-background,var(--vscode-editor-background)))!important;border-color:var(--vscode-editorHoverWidget-border,var(--vscode-widget-border,transparent))!important;box-sizing:border-box!important;color:var(--vscode-editorHoverWidget-foreground,var(--vscode-foreground))!important;overflow:visible!important;z-index:2147483647!important}.django-shell-overlay-widget-layer .monaco-hover .monaco-sash:not(.disabled),.django-shell-overlay-widget-layer .monaco-editor-hover .monaco-sash:not(.disabled){overflow:visible!important;pointer-events:auto!important;z-index:2147483647!important}.django-shell-overlay-widget-layer .suggest-widget,.django-shell-overlay-widget-layer .parameter-hints-widget,.django-shell-overlay-widget-layer .context-view{box-sizing:border-box!important;z-index:2147483647!important}";
    ...
    window.__dsoConfigureOverlayWidgets = function (root, editor) {
      ...
      try { window.__dsoInstallDetachedHoverKeeper && window.__dsoInstallDetachedHoverKeeper(root, editor); } catch (eHoverKeeper) { root.__dsoLastHoverKeeperError = String(eHoverKeeper && eHoverKeeper.message || eHoverKeeper); }
    };
