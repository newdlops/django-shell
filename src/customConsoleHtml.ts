...
@media (max-width:640px){.debugStatus{display:none}.iconText .buttonLabel{display:none}button.iconText{width:24px;padding:0}.topbar{gap:8px;padding:0 10px}.kernel{max-width:38vw}}
</style>
</head>
<body>
<div class="shell">
