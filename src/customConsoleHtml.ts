...
.debugStatus{font-size:11px;color:var(--vscode-descriptionForeground);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:180px}.debugStatus[data-state="attached"],.debugStatus[data-state="running"]{color:var(--vscode-terminal-ansiGreen,var(--vscode-charts-green,#3fb950))}.debugStatus[data-state="paused"],.debugStatus[data-state="starting"]{color:var(--vscode-charts-yellow,#cca700)}.debugStatus[data-state="error"]{color:var(--vscode-errorForeground)}
...
.debugInfo{display:grid;grid-template-columns:minmax(220px,.8fr) minmax(280px,1.4fr);gap:10px;padding:7px 14px;border-bottom:1px solid var(--vscode-panel-border);background:var(--vscode-editorWidget-background,var(--vscode-sideBar-background));font-size:12px}.debugInfo[hidden]{display:none}.debugFrame{display:flex;gap:7px;min-width:0}.debugFrameMain{min-width:0}.debugLocation,.debugSourceLine{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.debugLocation{font-weight:600}.debugSourceLine{margin-top:2px;color:var(--vscode-descriptionForeground);font-family:var(--vscode-editor-font-family)}.debugVariables{display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:4px;max-height:132px;overflow:auto}.debugScopeTitle{grid-column:1/-1;color:var(--vscode-descriptionForeground);font-size:11px}.debugVar{display:grid;grid-template-columns:minmax(66px,.42fr) minmax(0,1fr);gap:6px;min-width:0;padding:3px 6px;border:1px solid var(--vscode-panel-border);border-radius:4px;background:var(--vscode-editor-background)}.debugVarName{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--vscode-symbolIcon-variableForeground,var(--vscode-charts-blue))}.debugVarValue{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-family:var(--vscode-editor-font-family)}
