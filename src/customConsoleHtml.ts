  ...
  <main class="notebook">
    ...
    <section id="pythonCell" class="cell inputCell disabled">
      ...
      <div class="body editor">
        ...
        <div id="currentOutput" class="cellOutput outputHidden"><div class="outputToolbar"><h2 id="currentOutputLabel" class="outputLabel">Outputs</h2><div class="outputActions" role="group" aria-label="Execution output visibility"><button id="collapseOutputs" type="button" disabled>Collapse all</button><button id="expandOutputs" type="button" disabled>Expand all</button></div></div><div id="outputList" class="outputList"></div></div>
      </div>
    </section>
  </main>
</div>
