...
export function modelBrowserHtml(webview: vscode.Webview, extensionPath: string, options: ModelBrowserHtmlOptions = { mode: "model" }): string {
  ...
  const styles = webviewStylesheetLinks(webview, extensionPath, ["uiFoundation.css", "modelBrowser.css", "modelQueryBuilder.css", "modelQueryGuidance.css", "modelQueryWorkspace.css", "modelQueryControls.css", "modelQueryPopover.css"]);
...
<div class="app" data-surface="${options.mode}">
  ...
  ${options.mode === "model" ? `<section id="querySummaryBand" class="query-summary-band" aria-label="Applied query">
    ...
    <span id="queryHumanSummary" class="query-human-summary" tabindex="0"></span><span id="queryDirtyState" class="query-dirty-state" hidden aria-label="Draft changes not applied">Draft</span><span id="queryValidationState" class="query-validation-state" role="status">Checking…</span>
  </section>
