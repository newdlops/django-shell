...
<div class="app" data-surface="${options.mode}">
  ...
  <aside id="queryDrawer" class="query-drawer" aria-labelledby="queryBuilderTitle" data-query-builder-root hidden>
    ...
    <div class="query-quick-actions"><button id="queryClearFilters" class="secondary" type="button" hidden>Clear row filters</button><span class="spacer"></span><button id="queryAdvancedBuilder" class="secondary" type="button" hidden>Advanced query builder</button></div>
