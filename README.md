...
- **Sorting.** Click any header to stage asc/desc/none for a concrete or enabled computed column, then Apply the Query Builder draft. Read-only `@property` columns are excepted; window or non-primary ordering uses bounded OFFSET pagination.
