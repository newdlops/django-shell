// Sidebar webview: collapsible model tree (app → models) with a top search filter.
...
const state = { groups: [], ok: false, error: "", expanded: new Set() };
let debounce;
...
// Debounce input so typing never re-renders on every keystroke (avoids lag with thousands of models).
